...
int main()
{
    ...
    do
    {
        ...
        case 'P':
            ...
            {
                // DEBUG: Print the current round before the move
                cout << "Current Round Before Move: " << game.getBoard().getCurrentRound() << endl;
                ...
                if (game.isValid(turn))
                {
                    ...
                    // DEBUG: Print the played move and its score
                    cout << "Move Played: " << m.to_string() << endl;
                    Score s = game.getBoard().getScoreForRound(game.getBoard().getCurrentRound() - 1); // get the score for the last played round
                    cout << "Score for Move: " << s.to_string() << endl;
                }
                else
                {
                ...
                // DEBUG: Print the current round after the move
                cout << "Current Round After Move: " << game.getBoard().getCurrentRound() << endl;
            }
            break;
        }

        // DEBUG: Print the game outcome after each move
        cout << "Game Outcome: " << game.gameOutcomeAsString() << endl;
